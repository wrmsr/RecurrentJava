...
public class Graph
{
    ...
    public Matrix nonlin(final Nonlinearity neuron, final Matrix m)
            throws Exception
    {
    ...
    public Matrix smul(final Matrix m, final double s)
            throws Exception
    {
    ...
    public Matrix smul(final double s, final Matrix m)
            throws Exception
    {
        Matrix out = smul(m, s);
        return out;
